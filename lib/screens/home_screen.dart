      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasData && snapshot.data!.exists) {
            ...
            // 🚨 AQUI ESTÁ O VIGIA ATUALIZADO:
            // Permite o acesso à tela inicial se estiver ativo, em teste (trial) ou no respiro do atraso (overdue)
            if (status == 'inactive' || (status != 'active' && status != 'trial' && status != 'overdue')) {
              ...
              return const Center(child: Text('Assinatura inativa ou expirada...'));
            }
          }
          if (!snapshot.hasData || !snapshot.data!.exists) {
