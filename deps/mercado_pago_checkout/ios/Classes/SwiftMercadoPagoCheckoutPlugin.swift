...
public class SwiftMercadoPagoCheckoutPlugin: NSObject, FlutterPlugin, PXLifeCycleProtocol {

  var pendingResult: FlutterResult?

  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "mercado_pago_checkout", binaryMessenger: registrar.messenger())
    let instance = SwiftMercadoPagoCheckoutPlugin()
