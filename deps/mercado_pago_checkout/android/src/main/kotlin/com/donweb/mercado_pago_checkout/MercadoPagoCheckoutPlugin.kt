package com.donweb.mercado_pago_checkout
...
/** MercadoPagoCheckoutPlugin */
class MercadoPagoCheckoutPlugin: FlutterPlugin, MethodCallHandler, ActivityAware, ActivityResultListener {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "mercado_pago_checkout")
